...
var showAlerts = function showAlerts(type, msg) {
  hideAlert();
  var htmlmarkUp = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
...
exports.logoutUser = exports.login = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlerts)('success', 'Data updated successfully!');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlerts)('error', _context2.t0.response.data.message);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2LXN5ZG5leSIsImEiOiJjbDFqbWpzZTgyNmhxM3BwM3RvcTc0am40In0.9NAfNmmJO3C8qZcRu7Xf7g';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/dev-sydney/cl1lq1gno001114mh7k0tl3b3',
    // style URL
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //Setting the markers coordinates to add to the map
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51KtrcXHQab9KuPl1G2BMVNDuxLxGrHHbuc3J5pV4DGp4xDyPIsoHlOt6yPS1x5daGEE27ohGCgMgURVKi0lrY62X00z8pRRVXq'); //TODO: //1. Get the checkout session from the API
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            //console.log(res);
            if (res.data.status === 'success') {
              (0, _alerts.showAlerts)('success', "Hey ".concat(name.split(' ')[0], " your'e welcome!"));
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); //This returns an object
